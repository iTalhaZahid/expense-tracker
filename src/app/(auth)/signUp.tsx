...
const SignUp = () => {
    ...
    const signIn = () => router.replace('/signIn');
    ...
    const validation = async () => {
        if( !nameref.current || !passwordref.current || !emailref ){
                ...
                <View style={styles.topContainer}>
                    <View>
                        ...
                        <View style={{ gap: moderateVerticalScale(16), marginVertical: moderateVerticalScale(32) }}>
                            <Text style={styles.subText}>Create an account to track your expenses</Text>
                            ...
                            {
                                !isLoading && (
                                    <PrimaryButton text="Sign Up" onPress={validation} />
                                )
                            }
                            {
                                isLoading && (
